    ...
    <div className='h-screen'>
      ...
      <div className='grid grid-cols-[545.5px_854.5px] h-full'>
        ...
        <div className='bg-neutral-900 flex flex-col px-23 py-3 border-r border-neutral-700 '>
          ...
          <button className='w-fullbg-neutral-900 border border-neutral-600 text-white py-3 rounded-lg flex items-center justify-center gap-3 mb-4 text-sm font-semibold'>
          ...
          <button className='w-full bg-green-800 text-white py-2 rounded-lg text-lg mb-6 mt-7 border border-green-600 text-[15px] font-extralight'>Sign In</button>
          <div className='flex flex-col-2 justify-center'>
            <p className='text-gray-400 text-xs text-center pr-1 '>Don't have an account? </p>
            <span className='text-white cursor-pointert text-center underline text-sm'>Sign Up Now </span>
